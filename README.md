...
```PowerShell
java -cp target/kafka-case-1.0-SNAPSHOT-jar-with-dependencies.jar bigdata.nwmissouri.assignment.maligireddy.CustomConsumer
```
...
```PowerShell
java -cp target/kafka-case-1.0-SNAPSHOT-jar-with-dependencies.jar bigdata.nwmissouri.assignment.maligireddy.CustomProducer
```
